...
tf.flags.DEFINE_string("data_path",
                       "/mnt/win-F/work/text-projects/TextInfoExp/Part2_Text_Classify/",
...
label_binarizer = params['label_binarizer']
...
predictions_human_readable = np.column_stack((all_predictions_lables, np.array([text for text in x_raw])))
