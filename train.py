...
tf.flags.DEFINE_string("positive_data_file",
                       "/mnt/win-F/work/text-projects/zh_cnn_text_classify/data/ham_100.utf8",
                       "Data source for the positive data.")
tf.flags.DEFINE_string("negative_data_file",
                       "/mnt/win-F/work/text-projects/zh_cnn_text_classify/data/spam_100.utf8",
                       "Data source for the negative data.")
tf.flags.DEFINE_string("data_path",
                       "/mnt/win-F/deep-learning-data/text-datasets/dataset/raw/",
                       "Data source for the all data")
...
x_text, y, label_binarizer = data_helpers.load_multi_classes_files(FLAGS.data_path)
...
params = {'num_labels': FLAGS.num_labels, 'max_document_length': max_document_length, "label_binarizer": label_binarizer}
